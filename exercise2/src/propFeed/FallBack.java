 ...
 * The Class FallBack.
 */
public class FallBack implements Behavior{
	...
	/**
	 * Instantiates a new fall back.
	 *
	 * @param sensor the sensor
	 * @param pilot the pilot
	 */
	public FallBack(OpticalDistanceSensor sensor, DifferentialPilot pilot){
		this.sensor = sensor;
		this.pilot = pilot;
		control = false;
		suppressed = false;
	...
	public int distToSpeed(double distance, int range) {
		...
		double speed = (80 - distance*3) * pilot.getMaxTravelSpeed() / range;
		return (int) speed;
	}
