...
public class LineMapVisualisation extends JComponent {
	...
	private LineMapVisualisation(int _width, int _height, LineMap _lineMap,
		...
		setMinimumSize(new Dimension(m_visualisationDimensions.width, m_visualisationDimensions.width));
	...
	public void paint(Graphics g) {
		...
		Rectangle rectFill = new Rectangle(m_worldDimensions.width + X_MARGIN, m_worldDimensions.height + Y_MARGIN);
