...
/**
 * The Class GeneralNode. Used to store additional information about a node required in A* and generalised search algorithms
 *
...
public class GeneralNode<A> {
	 ...
	 *
	 * @param distToGoal the new distance to goal
	 */
