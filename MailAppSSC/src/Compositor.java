 ...
 * in the current project this class serves as a "model" although it is not since there is no reason to ensure further encapsulation for this class
 */
public class Compositor {
	 ...
	 */
	public Compositor(String username, String password){
